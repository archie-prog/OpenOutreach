...
urlpatterns = [
    ...
    path("api/inbox/thread/<int:thread_id>/suggest/", views.api_inbox_suggest, name="dashboard_api_inbox_suggest"),
    ...
    path("api/lead/<int:lead_id>/history/", views.api_lead_history, name="dashboard_api_lead_history"),
